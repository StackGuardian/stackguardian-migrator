...
#   W_TFORG W_TFHOST W_PROJECTS_JSON W_WSNAMES_JSON W_TAGS_JSON W_IGNORE_TAGS_JSON W_IGNORE_NAMES_JSON W_EXPORT_STATE
...
# Only these TFC projects, by name ([] = every project; each project becomes one
# workflow group). sg-migrate.sh --project narrows a single run further.
tfProjects = ${W_PROJECTS_JSON:-[]}
